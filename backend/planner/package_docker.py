...
def package_lambda():
    ...
    try:
        ...
        # These AI provider SDKs are pulled in by pydantic-ai but unused (we use Bedrock via LiteLLM)
        EXCLUDE_PREFIXES = [
        ...
        docker_cmd = [
            ...
            "-v", f"{backend_dir}/market_data:/market_data",
            "--entrypoint", "/bin/bash",
...
def deploy_lambda(zip_path):
    ...
    try:
        if size_mb > 50:
            ...
            s3_key = f"planner/planner_lambda.zip"
